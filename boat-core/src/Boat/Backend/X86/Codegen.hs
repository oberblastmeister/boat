module Boat.Backend.X86.Codegen
  ( compileModule,
  )
where
...
import Boat.Backend.X86.Frame qualified as Frame
import Boat.Backend.X86.Munch qualified as Munch
import Boat.Backend.X86.RegAlloc qualified as RegAlloc
import Boat.Backend.X86.X86 (InstLab, Reg (..), pattern (:@))
import Boat.Backend.X86.X86 qualified as X86
import Boat.LL qualified as LL
import Boat.LL.LowerGep qualified as LL.LowerGep
import Boat.Utils.Misc (concatToEither)
