...
maybeFail :: forall w es. '[Reporter w, Error Boat.Error.CompileFail] :>> es => Eff es ()
maybeFail = whenM (hadFatal @w) compileFail

reportFail :: forall w es a. '[Reporter w, Error Boat.Error.CompileFail] :>> es => w -> Eff es a
