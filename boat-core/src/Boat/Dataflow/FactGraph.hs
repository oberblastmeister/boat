...
module Boat.Dataflow.FactGraph
  ( FactGraph,
    FactBlock (FactBlock),
    FactBody,
    spliceLeft,
...
import Boat.Dataflow.Block (Block, Node)
import Boat.Dataflow.Block qualified as Block
import Boat.Dataflow.Graph (Body', Graph, Graph', NonLocal (..))
import Boat.Dataflow.Graph qualified as Graph
import Boat.Dataflow.Shape (Shape (..))
